      ...
      <div className="w-full max-w-md h-screen bg-white border-l border-gray-100 shadow-2xl flex flex-col">
        ...
        <div className="p-6 border-b border-gray-100">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-xl font-bold">Flight Requests</h2>
              <p className="text-sm text-gray-500">View your flight requests and their status</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 mt-2">
              Your flight requests will appear here once you make your first booking request.
            </p>
            <button 
              onClick={onBack}
