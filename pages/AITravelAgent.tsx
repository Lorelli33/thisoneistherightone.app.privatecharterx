  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      type: 'ai',
      content: "Hello! I'm Sphera, your AI Travel Assistant. Tell me about your dream journey, and I'll help you create the perfect travel experience. You can ask about destinations, activities, or specific travel requirements.",
      timestamp: new Date()
    }
  ]);
      ...
      <main className="flex-1 pt-[88px]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Chat with Sphera</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Experience personalized travel planning powered by artificial intelligence. Our AI assistant helps you discover and book the perfect private aviation experience.
            </p>
          </div>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
              ...
              <div className="p-6 border-b border-gray-100">
                <h2 className="text-2xl font-bold">Chat with Sphera</h2>
                <p className="text-gray-600">
                  Ask anything about private jet charters, destinations, or travel requirements
                </p>
              </div>
              ...
              <div className="p-6 border-t border-gray-100">
                <div className="flex gap-4">
                  ...
                  <button
                    ...
                    className="bg-black text-white px-6 rounded-xl hover:bg-gray-800  rounded-xl hover:bg-gray-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
                  >
                    <Send size={20} />
                  </button>
                </div>
